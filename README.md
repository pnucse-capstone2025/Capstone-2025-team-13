...
| <p align="center"><img src="https://github.com/JAEIL1999.png?size=100" width="80"/><br/><strong>박재일</strong></p> | _클라우드 기술의 이해를 높이고, 백엔드와 프론트엔드 개발부터 MLOps까지 전반적인 개발 과정을 경험하게 해준 의미 있는 프로젝트였습니다. 이를 통해 개발 역량을 한 단계 성장시킬 수 있었습니다._ |
