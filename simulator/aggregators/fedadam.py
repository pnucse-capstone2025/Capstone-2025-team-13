...
class FedAdam(fl.server.strategy.FedAvg):
    """FedAdam 전략 구현 (서버 측 Adam 최적화 사용)"""
    ...
    def __init__(
        ...
        *,
        ...
        # FedAdam은 fit_config에 eta_l 값을 포함하도록 on_fit_config_fn을 재정의
    ...
    def aggregate_fit(
        ...
        if hasattr(self, "global_model_parameters") and self.global_model_parameters is not None:
            ...
            self.v_t = [
                self.beta_2 * v + (1 - self.beta_2) * (delta ** 2)
    ...
    def __repr__(self) -> str:
        return f"FedAdam(eta={self.eta}, eta_l={self.eta_l}, beta_1={self.beta_1}, beta_2={self.beta_2}, tau={self.tau})"